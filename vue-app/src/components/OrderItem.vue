    ...
    <van-row>
      <van-col :span="24" :offset="1">
        ...
        <div style="margin-top:.5em">
          <van-button plain hairline size="small" type="warning" @click="PaymoneyHandler" v-if='data.status == "待支付"'>确认支付</van-button>
          <van-button plain hairline size="small" type="warning" style="margin-left:.5em"
            @click="ConfirmHandler" v-if='data.status == "待确认"'>确认订单
          </van-button>
        </div>
      </van-col>
    </van-row>

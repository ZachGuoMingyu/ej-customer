...
export default {
    ...
    actions: {
        ...
        async payHandler({dispatch},params){
            ...
            let url = 'http://47.106.244.1:5588/swagger-ui.html#!/category-controller/findAllUsingGET_1'
            let res = get('/order/paymoney?orderid='+params.orderid+'&customer_id='+params.customer_id+'&order_name=%E8%A3%A4%E5%AD%90&order_money='+params.order_money+'&description=%E5%B9%B2%E5%87%80')

  ...
  <div class="home">
    ...
    <header>
      <van-swipe class="my-swipe" :height="200" :autoplay="3000" indicator-color="white">
        <van-swipe-item >
          <img src="../../assets/index.jpg" alt="" style="width:100%;height:100%;">
        </van-swipe-item>
        
        <van-swipe-item>
          <img src="../../assets/index4.jpg" alt="" style="width:100%;height:100%;">
        </van-swipe-item>
        <van-swipe-item>
          <img src="../../assets/index5.jpg" alt="" style="width:100%;height:100%;">
        </van-swipe-item>
      </van-swipe>
    </header>
    <!-- /轮播图区域 -->
    ...
    <van-grid :column-num="2">
      <van-grid-item
        ...
        v-for="(p) in products"
        :key="p.id">
        <van-image style="height:100px;width:100%;" :src="'http://121.199.29.84:8888/group1/'+p.photo" />
        <div>{{p.name}}</div>
      </van-grid-item>
    </van-grid>
    <!-- {{products}} -->
